...
public interface UsuarioRepository extends JpaRepository<Usuario, Long> {
    ...
    @Query("SELECT DISTINCT u FROM Usuario u " +
            ...
            "LEFT JOIN u.roles r " +
            "LEFT JOIN u.recursos re " +  // ✅ Añadimos recursos a la búsqueda
            ...
            "OR LOWER(re.tipo) LIKE LOWER(CONCAT('%', :palabraClave, '%')) " +
            "OR LOWER(re.descripcion) LIKE LOWER(CONCAT('%', :palabraClave, '%'))")
    List<Usuario> buscarPorPalabraClave(@Param("palabraClave") String palabraClave);
